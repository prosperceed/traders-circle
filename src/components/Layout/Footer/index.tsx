			...
			<div className="container px-4">
				<div className="grid grid-cols-1 sm:grid-cols-11 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
					<div className="lg:col-span-4 md:col-span-6 col-span-6 flex flex-col gap-6">
						...
						<p className="text-white/60">
							Improve your forex knowledge in an unparalled way with
							Trader&apos;s Circle Institute
						</p>
						<div className="flex gap-6 items-center relative z-1">
							<Link
								href="https://www.facebook.com/share/19Px8B2TzE/"
								className="group"
							>
								<Icon
                ...
                />
					...
					{/* <div className="lg:col-span-3 md:col-span-4 col-span-6">
						<h3 className="text-white text-24 font-medium mb-4">Resources</h3>
						<div className="flex flex-col gap-4">
							<Link href={"#"}>Youtube</Link>
							<Link href={"https://www.apple.com/"}>Telegram</Link>
						</div>
					</div> */}
				</div>
				<p className="text-white/40 text-center py-8 border-t border-white/20">
					Copy &copy; Right, Trader&apos;s Circle Institute 2025
				</p>
			</div>
		</footer>
	);
