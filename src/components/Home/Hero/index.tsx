					...
					<motion.div {...leftAnimation} className="flex flex-col gap-10">
						<div className="flex flex-col gap-4 text-center md:text-left">
							...
							<p className="text-white">
								Experience revolutionary trading with Trader's Circle. Our
								platform empowers you to trade with confidence, backed by a
								community of experts and cutting-edge tools.
							</p>
							<div className="flex gap-6 items-center lg:justify-start justify-center">
								<div className="py-1.5 px-4 bg-cyan-300/10 rounded-full border border-cyan-400">
