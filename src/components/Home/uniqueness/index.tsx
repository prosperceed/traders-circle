...
import { uniquenessData } from "@/app/api/data";
...
const Uniqueness = () => {
	...
	return (
		<section className="md:pt-40 pt-9" id="uniqueness">
					...
					>
						<div className="flex flex-col gap-4">
							<p className="text-white font-medium">
								Why <span className="text-primary">Trader&apos;s Circle</span>
							</p>
							<h2 className="text-white sm:text-40 text-30 font-medium lg:w-80% mx-auto mb-20">
								We Improve Your Trading life
							</h2>
						</div>
					</motion.div>
					<motion.div
						...
						<div className="md:block hidden relative">
							...
							<div className="absolute lg::top-40 top-36 lg:left-0 -left-20 w-72 flex items-center gap-6">
								<div className="text-right">
									...
									<p className="text-15 text-muted/60">
										Strategy places you ahead of the game, and We teach just the
										best of it
									</p>
								</div>
							...
							<div className="absolute lg:top-40 top-36 lg:right-0 -right-20 w-72 flex items-center justify-center gap-6">
								...
								<div className="text-left">
									<h5 className="text-muted text-28 mb-3">Sharp emotions</h5>
									<p className="text-15 text-muted/60">
										Boost your confidence and learn how to control your emotions
									</p>
								</div>
							</div>
							<div className="absolute lg:bottom-48 bottom-36 lg:left-0 -left-20 w-72 flex items-center gap-6">
								<div className="text-right">
									<h5 className="text-muted text-28 mb-3">Journaling</h5>
									<p className="text-15 text-muted/60">
										A good trade starts from how well you plan it
									</p>
								</div>
								{/* <div className="bg-light_grey/45 backdrop-blur-xs px-6 py-2 h-fit rounded-full">
									<Image
							...
							<div className="absolute lg:bottom-48 bottom-36 lg:right-0 -right-20 w-72 flex items-center gap-6">
								...
								<div className="text-left">
									...
									<p className="text-15 text-muted/60">
										Learn how to manage your risk and protect your capital
									</p>
								</div>
							</div>
						</div>
